...
# create function to determine if rock is in rover view
def is_rock(rock_angles):

    # determine if a rock is present
    if len(rock_angles > 0):
        rock = 1
        angles = rock_angles
    # if no rock present, return 0
    else:
        rock = 0
        angles = 0
    return rock, angles
...
def update_rover(Rover, data):
      ...
      # NOTE added in rover mode and nav angle
